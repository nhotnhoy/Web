...
function render() {
  ...
  for (let i = 0; i < deleteBtns.length; i++) {
    ...
    editBtns[i].addEventListener('click', () => {
      ...
      $('textarea[name="description"]').value = products[i].description;
...
Validator({
  ...
  rules: [
    ...
    Validator.isNonNegative('input[name="count"]', 'Vui lòng nhập số lượng không âm'),
    ...
    Validator.isNonNegative('input[name="price"]', 'Vui lòng nhập giá không âm'),
  ],
