...
function dc() {
    var inputValue = loginUser.phone
    document.getElementById('sdt').value = inputValue
}
dc()
function toggleInput(enable) {
    ...
    if (!enable) {
        var inputValue = loginUser.location
        document.getElementById('diachi').value = inputValue
    } else {
